...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		FlxG.save.bind('extrakeys', 'tposejank');
	...
	function startIntro()
	{
		...
		gfDance.frames = Paths.getSparrowAtlas('tito');
		gfDance.antialiasing = true;
		gfDance.animation.addByPrefix('bump', 'bump', 24, false);
		...
		logoSpr = new FlxSprite(0, FlxG.height * 0.4).loadGraphic(Paths.image('khnlogo'));
		add(logoSpr);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					addMoreText('WE GAMIN');
				case 7:
					addMoreText('WOOOOOOOOOOO');
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('what'); // credTextShit.text += '\nFunkin';
